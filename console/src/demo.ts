...
const settings = {
  ...
  networking: { preview_domain: 'localhost', public_http_port: '80', preview_base: 'http://*.preview.localhost', preview_host_style: 'nested', preview_tls: false, preview_entrypoint: 'web' },
  auth: { enabled: false },
