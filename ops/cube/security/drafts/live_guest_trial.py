...
parser = argparse.ArgumentParser(description="UNEXECUTED DRAFT: " + __doc__)
parser.add_argument("--allow-unvalidated-draft", action="store_true", required=True, help="explicitly acknowledge this draft has not been run end to end")
